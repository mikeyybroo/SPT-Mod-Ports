...
namespace SPTQuestingBots.Controllers.Bots
{
    public class BotQuestBuilder : MonoBehaviour
    {
        ...
        public static void AddAirdropChaserQuest(Vector3 airdropPosition)
        {
            ...
            if (GClass1473.PastTimeSeconds(Singleton<AbstractGame>.Instance.GameTimer) < 1)
            {
            ...
            {
                float raidET = GClass1473.PastTimeSeconds(Singleton<AbstractGame>.Instance.GameTimer);
