...
namespace DrakiaXYZ.QuestTracker.Components
{
    internal class QuestTrackerComponent : MonoBehaviour
    {
        ...
        private Dictionary<string, Quest> trackedQuests = new Dictionary<string, Quest>();
        ...
        public void Awake()
        {
            ...
            foreach (var quest in player.Profile.QuestsData)
            {
                ...
                {
                    Quest questInstance = Utils.GetQuest(questController, quest.Id);
        ...
        public object LocalGameType { get; set; }
        ...
        private void QuestUntracked(object sender, Quest quest)
        {
            CacheQuests();
        }
