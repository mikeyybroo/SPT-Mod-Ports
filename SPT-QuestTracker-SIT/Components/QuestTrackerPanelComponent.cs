...
namespace DrakiaXYZ.QuestTracker.Components
{
    internal class QuestTrackerPanelComponent : MonoBehaviour
    {
        ...
        public void SetQuests(Dictionary<string, Quest> trackedQuests, List<Quest> mapQuests)
        {
        ...
        public void SetupQuest(Quest quest, ref int questIndex, ref int objectiveIndex, ref int siblingIndex)
        {
        ...
        private int SetupQuestObject(Quest quest, int questIndex, ref int siblingIndex)
        {
        ...
        private int SetupQuestObjectiveObjects(Quest quest, int objectiveIndex, ref int siblingIndex)
        {
            // Filter out any quest that isn't currently started/done/failed
            EQuestStatus status = quest.QuestStatus;
            if (status != EQuestStatus.Started && status != EQuestStatus.AvailableForFinish && status != EQuestStatus.MarkedAsFailed)
        ...
        private void CreateObjectivePrefabs(Dictionary<string, Quest> trackedQuests, List<Quest> mapQuests)
        {
        ...
        private int GetObjectiveCount(Quest quest)
        {
            // Filter out any quest that isn't currently started/done/failed
            EQuestStatus status = quest.QuestStatus;
            if (status != EQuestStatus.Started && status != EQuestStatus.AvailableForFinish && status != EQuestStatus.MarkedAsFailed)
