...
namespace DrakiaXYZ.QuestTracker.Helpers
{
    internal class Utils
    {
        ...
        public static void Init()
        {
            ...
            Type stringLocalizeClass = StayInTarkovHelperConstants.EftTypes.First(x => x.GetMethod("Localized", localizedParams) != null);
            ...
            _questConditionHandlersField = AccessTools.Field(typeof(Quest), "ConditionHandlers");
        }
        ...
        public static Quest GetQuest(QuestControllerClass questController, string questId)
        {
            object quests = _questControllerQuestsField.GetValue(questController);
            return _getQuestMethod.Invoke(quests, new object[] { questId }) as Quest;
        }
        ...
        public static IDictionary GetConditionHandlers(Quest quest)
        {
